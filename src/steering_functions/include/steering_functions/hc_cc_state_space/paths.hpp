...
namespace steering
{
    ...
    public:
        /** \brief Constructor */
        Path(const Configuration& _start,
    ...
    public:
        /** \brief Constructor */
        CC_Dubins_Path(const Configuration& _start,
                       const Configuration& _end,
    ...
    public:
        /** \brief Constructor */
        HC_CC_RS_Path(const Configuration& _start,
                      const Configuration& _end,
    ...
    void straight_controls(const Configuration&  q1,
    ...
    /** \brief Appends controls with a default cc-turn consisting of two clothoids and a circular
     * arc */
