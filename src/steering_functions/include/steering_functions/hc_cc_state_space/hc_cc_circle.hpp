...
namespace steering
{
    ...
    public:
        ...
        /** \brief Angle between the initial orientation and the tangent to the circle at the
         * initial position */
        double mu;
    ...
    public:
        /** \brief Constructor */
        HC_CC_Circle(const Configuration&      _start,
                     bool                      _left,
                     bool                      _forward,
                     bool                      _regular,
        ...
        /** \brief Computation of deflection (angle between start configuration of circle and
         * configuration q) */
