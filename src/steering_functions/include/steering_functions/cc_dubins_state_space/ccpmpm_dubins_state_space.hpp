...
namespace steering
{
    ...
    public:
        /** \brief Constructor */
        CCpmpm_Dubins_State_Space(double kappa,
                                  double sigma,
        ...
        /** \brief Returns a sequence of turns and straight lines connecting the two circles c1 and
         * c2 */
        CC_Dubins_Path* ccpmpm_circles_dubins_path(const HC_CC_Circle& c1,
                                                   const HC_CC_Circle& c2) const;

        /** \brief Returns a sequence of turns and straight lines connecting a start and an end
         * configuration */
    ...
    private:
        ...
        /** \brief Angle between a configuration on the hc-/cc-circle and the tangent to the circle
         * at that position */
        double mu_;
