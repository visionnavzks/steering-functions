...
Configuration get_cc_goal_config(double delta, const HC_CC_Circle_Param& hc_cc_circle_param)
{
    ...
    // goal config of cc-turn given in local frame (aligned with start config) assuming left =
    // forward = true
    Configuration goal;
...
Configuration get_hc_goal_config(double delta, const HC_CC_Circle_Param& hc_cc_circle_param)
{
    ...
    // goal config of hc-turn given in local frame (aligned with start config) assuming left =
    // forward = true
    Configuration goal;
