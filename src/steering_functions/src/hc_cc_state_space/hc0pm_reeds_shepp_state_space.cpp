...
namespace steering
{
    ...
    public:
        explicit HC0pm_Reeds_Shepp(HC0pm_Reeds_Shepp_State_Space* parent) { parent_ = parent; }
                       ...
                       Configuration**     q2) const
        {
            ...
            *cstart = new HC_CC_Circle(
                c1.start, c1.left, c1.forward, CC_REGULAR, parent_->hc_cc_circle_param_);
            *cend = new HC_CC_Circle(
                **q1, c2.left, !c2.forward, HC_REGULAR, parent_->hc_cc_circle_param_);
                          ...
                          HC_CC_Circle**      ci) const
        {
            ...
            *cend   = new HC_CC_Circle(c2);
            ...
            double length1 = (*cstart)->hc_turn_length(*qa) + middle1->rs_turn_length(*qb) +
                             (*cend)->rs_turn_length(*qb);
            double length2 = (*cstart)->hc_turn_length(*qc) + middle2->rs_turn_length(*qd) +
                         ...
                         HC_CC_Circle**      ci) const
        {
            ...
            *q2     = new Configuration(c2.start.x, c2.start.y, c2.start.theta, c2.kappa);
            ...
            // select shortest connection
            double length1 = (*cstart)->hc_turn_length(*qa) + middle1->hc_turn_length(*qa) +
                             end1->hc_turn_length(**q2);
            double length2 = (*cstart)->hc_turn_length(*qc) + middle2->hc_turn_length(*qc) +
                         ...
                         HC_CC_Circle**      ci) const
        {
            ...
            *cend = new HC_CC_Circle(c2);
            ...
            // select shortest connection
            double length1 = (*cstart)->cc_turn_length(*qa) + middle1->hc_turn_length(*qb) +
                             (*cend)->rs_turn_length(*qb);
            double length2 = (*cstart)->cc_turn_length(*qc) + middle2->hc_turn_length(*qd) +
                             (*cend)->rs_turn_length(*qd);
            if (length1 < length2)
            {
                *q1 = qa;
                         ...
                         Configuration**     q3) const
        {
            ...
            *q3 = new Configuration(c2.start.x, c2.start.y, c2.start.theta, c2.kappa);
            return (*cstart)->cc_turn_length(**q1) + configuration_distance(**q1, **q2) +
        ...
        bool TiSTcT_exists(const HC_CC_Circle& c1, const HC_CC_Circle& c2) const
        {
            ...
            return (distance >= sqrt(pow(2 * c1.radius * c1.sin_mu + 2 * fabs(c1.kappa_inv), 2) +
        ...
        bool TcTiSTcT_exists(const HC_CC_Circle& c1, const HC_CC_Circle& c2) const
        {
            ...
            return (distance >=
                    sqrt(pow(2 * c1.radius, 2) + 16 * c1.radius * c1.sin_mu * fabs(c1.kappa_inv) +
                          ...
                          HC_CC_Circle**      ci2) const
        {
            ...
            *q3 = new Configuration(c2.start.x, c2.start.y, c2.start.theta, c2.kappa);
            ...
            double length2 = (*cstart)->cc_turn_length(*qd) + middle3->hc_turn_length(*qe) +
                           ...
                           HC_CC_Circle**      ci2) const
        {
            ...
            *cend   = new HC_CC_Circle(c2);
            ...
            double length2 = (*cstart)->hc_turn_length(*qd) + middle3->hc_turn_length(*qd) +
                        ...
                        HC_CC_Circle**      ci) const
        {
            ...
            *q3 = new Configuration(c2.start.x, c2.start.y, c2.start.theta, c2.kappa);
            ...
            // select shortest connection
            double length1 = (*cstart)->cc_turn_length(*qa) + middle1->cc_turn_length(*qb) +
                             end1->hc_turn_length(**q3);
            double length2 = (*cstart)->cc_turn_length(*qc) + middle2->cc_turn_length(*qd) +
                          ...
                          Configuration**     q3) const
        {
            ...
            *cend   = new HC_CC_Circle(
                **q2, c2.left, !c2.forward, HC_REGULAR, parent_->hc_cc_circle_param_);
            return (*cstart)->hc_turn_length(**q1) + configuration_distance(**q1, **q2) +
                   (*cend)->hc_turn_length(**q3);
        }
    ...
    HC0pm_Reeds_Shepp_State_Space::HC0pm_Reeds_Shepp_State_Space(double kappa,
                                                                 double sigma,
    ...
    HC_CC_RS_Path*
    HC0pm_Reeds_Shepp_State_Space::hc0pm_circles_rs_path(const HC_CC_Circle& c1,
                                                         const HC_CC_Circle& c2) const
    {
        ...
        {
            cstart[hc_cc_rs::T] =
                new HC_CC_Circle(c1.start, c1.left, c1.forward, HC_REGULAR, hc_cc_circle_param_);
        ...
        {
            length[hc_cc_rs::TT] = hc0pm_reeds_shepp_->TT_path(c1,
                                                               c2,
                                                               &cstart[hc_cc_rs::TT],
                                                               &cend[hc_cc_rs::TT],
                                                               &qi1[hc_cc_rs::TT],
        ...
        {
            length[hc_cc_rs::TcT] = hc0pm_reeds_shepp_->TcT_path(
        ...
        {
            length[hc_cc_rs::TcTcT] = hc0pm_reeds_shepp_->TcTcT_path(c1,
                                                                     c2,
        ...
        {
            length[hc_cc_rs::TcTT] = hc0pm_reeds_shepp_->TcTT_path(c1,
                                                                   c2,
        ...
        {
            length[hc_cc_rs::TTcT] = hc0pm_reeds_shepp_->TTcT_path(c1,
                                                                   c2,
        ...
        {
            length[hc_cc_rs::TST] = hc0pm_reeds_shepp_->TST_path(c1,
                                                                 c2,
                                                                 &cstart[hc_cc_rs::TST],
                                                                 &cend[hc_cc_rs::TST],
                                                                 &qi1[hc_cc_rs::TST],
        ...
        {
            length[hc_cc_rs::TSTcT] = hc0pm_reeds_shepp_->TSTcT_path(c1,
                                                                     c2,
        ...
        {
            length[hc_cc_rs::TcTST] = hc0pm_reeds_shepp_->TcTST_path(c1,
                                                                     c2,
        ...
        {
            length[hc_cc_rs::TcTSTcT] = hc0pm_reeds_shepp_->TcTSTcT_path(c1,
                                                                         c2,
        ...
        {
            length[hc_cc_rs::TTcTT] = hc0pm_reeds_shepp_->TTcTT_path(c1,
                                                                     c2,
        ...
        {
            length[hc_cc_rs::TcTTcT] = hc0pm_reeds_shepp_->TcTTcT_path(c1,
                                                                       c2,
        ...
        {
            length[hc_cc_rs::TTT] = hc0pm_reeds_shepp_->TTT_path(c1,
                                                                 c2,
                                                                 &cstart[hc_cc_rs::TTT],
                                                                 &cend[hc_cc_rs::TTT],
                                                                 &qi1[hc_cc_rs::TTT],
        ...
        {
            length[hc_cc_rs::TcST] = hc0pm_reeds_shepp_->TcST_path(c1,
                                                                   c2,
        ...
        {
            length[hc_cc_rs::TScT] = hc0pm_reeds_shepp_->TScT_path(c1,
                                                                   c2,
        ...
        {
            length[hc_cc_rs::TcScT] = hc0pm_reeds_shepp_->TcScT_path(c1,
                                                                     c2,
    ...
    HC_CC_RS_Path* HC0pm_Reeds_Shepp_State_Space::hc0pm_reeds_shepp(const State& state1,
    ...
    double HC0pm_Reeds_Shepp_State_Space::get_distance(const State& state1,
                                                       const State& state2) const
    {
    ...
    vector<Control> HC0pm_Reeds_Shepp_State_Space::get_controls(const State& state1,
                                                                const State& state2) const
    {
