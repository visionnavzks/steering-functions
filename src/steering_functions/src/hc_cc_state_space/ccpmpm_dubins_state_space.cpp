...
namespace steering
{
    ...
    public:
        explicit CCpmpm_Dubins(CCpmpm_Dubins_State_Space* parent) { parent_ = parent; }
                       ...
                       Configuration**     q3) const
        {
            ...
            *cstart =
                new HC_CC_Circle(**q2, c1.left, !c1.forward, true, parent_->hc_cc_circle_param_);
            *cend =
                new HC_CC_Circle(**q2, c2.left, !c2.forward, true, parent_->hc_cc_circle_param_);
                         ...
                         Configuration**     q4) const
        {
            ...
            *cstart =
                new HC_CC_Circle(**q2, c1.left, !c1.forward, true, parent_->hc_cc_circle_param_);
            *cend =
                new HC_CC_Circle(**q3, c2.left, !c2.forward, true, parent_->hc_cc_circle_param_);
            *q1 = new Configuration(c1.start.x, c1.start.y, c1.start.theta, c1.kappa);
        ...
        void TTTT_tangent_circles(const HC_CC_Circle& c1,
                                  const HC_CC_Circle& c2,
                                  Configuration**     q1,
                                  Configuration**     q2,
                                  Configuration**     q3,
        ...
        double TTTT_path(const HC_CC_Circle& c1,
                         const HC_CC_Circle& c2,
                         HC_CC_Circle**      cstart,
                         HC_CC_Circle**      cend,
                         Configuration**     q1,
                         ...
                         HC_CC_Circle**      ci2) const
        {
            ...
            *q3 = new Configuration(c2.start.x, c2.start.y, c2.start.theta, c2.kappa);
            ...
            // select shortest connection
            double length1 = start1->hc_turn_length(**q1) + middle1->cc_turn_length(*qb) +
                             middle2->cc_turn_length(*qb) + end1->hc_turn_length(**q3);
            double length2 = start2->hc_turn_length(**q1) + middle3->cc_turn_length(*qe) +
                             middle4->cc_turn_length(*qe) + end2->hc_turn_length(**q3);
            if (length1 < length2)
            {
                *cstart = start1;
                *cend   = end1;
    ...
    CCpmpm_Dubins_State_Space::CCpmpm_Dubins_State_Space(double kappa,
                                                         double sigma,
    ...
    CC_Dubins_Path*
    CCpmpm_Dubins_State_Space::ccpmpm_circles_dubins_path(const HC_CC_Circle& c1,
                                                          const HC_CC_Circle& c2) const
    {
        ...
        {
            length[cc_dubins::TT] = ccpmpm_dubins_->TT_path(c1,
                                                            c2,
                                                            &cstart[cc_dubins::TT],
                                                            &cend[cc_dubins::TT],
                                                            &qi1[cc_dubins::TT],
        ...
        {
            length[cc_dubins::TST] = ccpmpm_dubins_->TST_path(c1,
                                                              c2,
                                                              &cstart[cc_dubins::TST],
                                                              &cend[cc_dubins::TST],
                                                              &qi1[cc_dubins::TST],
                                                              &qi2[cc_dubins::TST],
                                                              &qi3[cc_dubins::TST],
        ...
        {
            length[cc_dubins::TTT] = ccpmpm_dubins_->TTT_path(c1,
                                                              c2,
                                                              &cstart[cc_dubins::TTT],
                                                              &cend[cc_dubins::TTT],
                                                              &qi1[cc_dubins::TTT],
                                                              &qi2[cc_dubins::TTT],
                                                              &qi3[cc_dubins::TTT],
        ...
        {
            length[cc_dubins::TTTT] = ccpmpm_dubins_->TTTT_path(c1,
                                                                c2,
                                                                &cstart[cc_dubins::TTTT],
                                                                &cend[cc_dubins::TTTT],
                                                                &qi1[cc_dubins::TTTT],
                                                                &qi2[cc_dubins::TTTT],
                                                                &qi3[cc_dubins::TTTT],
    ...
    label_end:
        ...
        CC_Dubins_Path* path;
        path = new CC_Dubins_Path(c1.start,
                                  c2.start,
                                  best_path,
                                  kappa_,
                                  sigma_,
    ...
    CC_Dubins_Path* CCpmpm_Dubins_State_Space::ccpmpm_dubins(const State& state1,
                                                             const State& state2) const
    {
        ...
        // compute the shortest path for the 4 combinations (2 circles at the beginning and 2 at the
        // end)
    ...
    vector<Control> CCpmpm_Dubins_State_Space::get_controls(const State& state1,
                                                            const State& state2) const
    {
