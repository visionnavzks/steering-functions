...
namespace steering
{
    ...
    public:
        explicit HC00_Reeds_Shepp(HC00_Reeds_Shepp_State_Space* parent) { parent_ = parent; }
    ...
    HC00_Reeds_Shepp_State_Space::HC00_Reeds_Shepp_State_Space(double kappa,
                                                               double sigma,
    ...
    HC_CC_RS_Path* HC00_Reeds_Shepp_State_Space::hc00_circles_rs_path(const HC_CC_Circle& c1,
                                                                      const HC_CC_Circle& c2) const
    {
        ...
        {
            cstart[hc_cc_rs::T] =
                new HC_CC_Circle(c1.start, c1.left, c1.forward, CC_REGULAR, hc_cc_circle_param_);
        ...
        {
            length[hc_cc_rs::TcT] = hc00_reeds_shepp_->TcT_path(
        ...
        {
            length[hc_cc_rs::TcTcT] = hc00_reeds_shepp_->TcTcT_path(c1,
                                                                    c2,
        ...
        {
            length[hc_cc_rs::TcTT] = hc00_reeds_shepp_->TcTT_path(c1,
                                                                  c2,
        ...
        {
            length[hc_cc_rs::TTcT] = hc00_reeds_shepp_->TTcT_path(c1,
                                                                  c2,
        ...
        {
            length[hc_cc_rs::TST] = hc00_reeds_shepp_->TST_path(c1,
                                                                c2,
                                                                &cstart[hc_cc_rs::TST],
                                                                &cend[hc_cc_rs::TST],
                                                                &qi1[hc_cc_rs::TST],
        ...
        {
            length[hc_cc_rs::TSTcT] = hc00_reeds_shepp_->TSTcT_path(c1,
                                                                    c2,
        ...
        {
            length[hc_cc_rs::TcTST] = hc00_reeds_shepp_->TcTST_path(c1,
                                                                    c2,
        ...
        {
            length[hc_cc_rs::TcTSTcT] = hc00_reeds_shepp_->TcTSTcT_path(c1,
                                                                        c2,
        ...
        {
            length[hc_cc_rs::TTcTT] = hc00_reeds_shepp_->TTcTT_path(c1,
                                                                    c2,
        ...
        {
            length[hc_cc_rs::TcTTcT] = hc00_reeds_shepp_->TcTTcT_path(c1,
                                                                      c2,
        ...
        {
            length[hc_cc_rs::TTT] = hc00_reeds_shepp_->TTT_path(c1,
                                                                c2,
                                                                &cstart[hc_cc_rs::TTT],
                                                                &cend[hc_cc_rs::TTT],
                                                                &qi1[hc_cc_rs::TTT],
        ...
        {
            length[hc_cc_rs::TcST] = hc00_reeds_shepp_->TcST_path(c1,
                                                                  c2,
        ...
        {
            length[hc_cc_rs::TScT] = hc00_reeds_shepp_->TScT_path(c1,
                                                                  c2,
        ...
        {
            length[hc_cc_rs::TcScT] = hc00_reeds_shepp_->TcScT_path(c1,
                                                                    c2,
    ...
    HC_CC_RS_Path* HC00_Reeds_Shepp_State_Space::hc00_reeds_shepp(const State& state1,
    ...
    double HC00_Reeds_Shepp_State_Space::get_distance(const State& state1,
                                                      const State& state2) const
    {
    ...
    vector<Control> HC00_Reeds_Shepp_State_Space::get_controls(const State& state1,
                                                               const State& state2) const
    {
