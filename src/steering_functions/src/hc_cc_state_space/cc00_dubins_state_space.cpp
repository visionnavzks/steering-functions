...
namespace steering
{
    ...
    public:
        explicit CC00_Dubins(CC00_Dubins_State_Space* parent) { parent_ = parent; }
    ...
    CC00_Dubins_State_Space::CC00_Dubins_State_Space(double kappa,
                                                     double sigma,
    ...
    CC_Dubins_Path* CC00_Dubins_State_Space::cc00_circles_dubins_path(const HC_CC_Circle& c1,
                                                                      const HC_CC_Circle& c2) const
    {
        ...
        if (cc00_dubins_->TT_exists(c1, c2))
        {
            ...
            length[cc_dubins::TT] = cc00_dubins_->TT_path(
                *cstart[cc_dubins::TT], *cend[cc_dubins::TT], &qi1[cc_dubins::TT]);
        }
        // ##### Dubins families: ######################################################
        // case TST
        if (cc00_dubins_->TST_exists(c1, c2))
        {
            ...
            length[cc_dubins::TST] = cc00_dubins_->TST_path(*cstart[cc_dubins::TST],
                                                            *cend[cc_dubins::TST],
                                                            &qi1[cc_dubins::TST],
                                                            &qi2[cc_dubins::TST]);
        }
        ...
        if (cc00_dubins_->TTT_exists(c1, c2))
        {
            ...
            length[cc_dubins::TTT] = cc00_dubins_->TTT_path(*cstart[cc_dubins::TTT],
                                                            *cend[cc_dubins::TTT],
                                                            &qi1[cc_dubins::TTT],
                                                            &qi2[cc_dubins::TTT],
                                                            &ci1[cc_dubins::TTT]);
    ...
    CC_Dubins_Path* CC00_Dubins_State_Space::cc00_dubins(const State& state1,
    ...
    vector<Control> CC00_Dubins_State_Space::get_controls(const State& state1,
                                                          const State& state2) const
    {
