...
namespace steering
{
    ...
    public:
        explicit HCpm0_Reeds_Shepp(HCpm0_Reeds_Shepp_State_Space* parent) { parent_ = parent; }
        ...
        {
            return path_helpers::TT_exists(distance, c1, c2, c2.radius);
        }
        void
        TT_tangent_circles(const HC_CC_Circle& c1, const HC_CC_Circle& c2, Configuration** q) const
        {
            path_helpers::TT_tangent_circles(c1, c2, c2.mu, q);
        }
                       ...
                       Configuration**     q2) const
        {
            ...
            *cend = new HC_CC_Circle(
                c2.start, c2.left, c2.forward, CC_REGULAR, parent_->hc_cc_circle_param_);
        ...
        {
            return path_helpers::TcTT_exists(distance, c1, c2, 2 * c2.radius + 2 * fabs(c2.kappa_inv), 2 * c2.radius - 2 * fabs(c2.kappa_inv));
        }
        ...
        {
            return path_helpers::TTcT_exists(distance, c1, c2, 2 * c2.radius + 2 * fabs(c2.kappa_inv), 2 * c2.radius - 2 * fabs(c2.kappa_inv));
        }
        ...
        {
            return path_helpers::TiST_exists(distance, c1, c2, c2.radius);
        }
        bool TeST_exists(const HC_CC_Circle& c1, const HC_CC_Circle& c2) const
        {
            return path_helpers::TeST_exists(distance, c1, c2, c2.radius * c2.sin_mu);
        }
        bool TST_exists(const HC_CC_Circle& c1, const HC_CC_Circle& c2) const
        {
            return path_helpers::TST_exists(distance, c1, c2, c2.radius, c2.radius * c2.sin_mu);
        }
        void TiST_tangent_circles(const HC_CC_Circle& c1,
                                  ...
                                  Configuration**     q2) const
        {
            path_helpers::TiST_tangent_circles(c1, c2, c2.radius, c2.sin_mu, c2.cos_mu, q1, q2);
        }
        void TeST_tangent_circles(const HC_CC_Circle& c1,
                                  ...
                                  Configuration**     q2) const
        {
            path_helpers::TeST_tangent_circles(c1, c2, c2.radius, c2.sin_mu, c2.cos_mu, q1, q2);
        }
        ...
        bool TiSTcT_exists(const HC_CC_Circle& c1, const HC_CC_Circle& c2) const
        {
            ...
            return (distance >= sqrt(pow(2 * c2.radius * c2.sin_mu + 2 * fabs(c2.kappa_inv), 2) +
        ...
        bool TcTiSTcT_exists(const HC_CC_Circle& c1, const HC_CC_Circle& c2) const
        {
            ...
            return (distance >=
                    sqrt(pow(2 * c2.radius, 2) + 16 * c2.radius * c2.sin_mu * fabs(c2.kappa_inv) +
        ...
        {
            return path_helpers::TTcTT_exists(distance, c1, c2, 4 * c2.radius + 2 * fabs(c2.kappa_inv));
        }
        ...
        {
            return path_helpers::TcTTcT_exists(distance, c1, c2, 4 * fabs(c2.kappa_inv) + 2 * c2.radius, 4 * fabs(c2.kappa_inv) - 2 * c2.radius);
        }
        ...
        {
            return path_helpers::TTT_exists(distance, c1, c2, c2.radius);
        }
    ...
    HCpm0_Reeds_Shepp_State_Space::HCpm0_Reeds_Shepp_State_Space(double kappa,
                                                                 double sigma,
    ...
    HC_CC_RS_Path*
    HCpm0_Reeds_Shepp_State_Space::hcpm0_circles_rs_path(const HC_CC_Circle& c1,
                                                         const HC_CC_Circle& c2) const
    {
        ...
        {
            cend[hc_cc_rs::T] =
                new HC_CC_Circle(c2.start, c2.left, c2.forward, HC_REGULAR, hc_cc_circle_param_);
        ...
        {
            length[hc_cc_rs::TT] = hcpm0_reeds_shepp_->TT_path(c1,
                                                               c2,
                                                               &cstart[hc_cc_rs::TT],
                                                               &cend[hc_cc_rs::TT],
                                                               &qi1[hc_cc_rs::TT],
        ...
        {
            length[hc_cc_rs::TcT] = hcpm0_reeds_shepp_->TcT_path(
        ...
        {
            length[hc_cc_rs::TcTcT] = hcpm0_reeds_shepp_->TcTcT_path(c1,
                                                                     c2,
        ...
        {
            length[hc_cc_rs::TcTT] = hcpm0_reeds_shepp_->TcTT_path(c1,
                                                                   c2,
        ...
        {
            length[hc_cc_rs::TTcT] = hcpm0_reeds_shepp_->TTcT_path(c1,
                                                                   c2,
        ...
        {
            length[hc_cc_rs::TST] = hcpm0_reeds_shepp_->TST_path(c1,
                                                                 c2,
                                                                 &cstart[hc_cc_rs::TST],
                                                                 &cend[hc_cc_rs::TST],
                                                                 &qi1[hc_cc_rs::TST],
        ...
        {
            length[hc_cc_rs::TSTcT] = hcpm0_reeds_shepp_->TSTcT_path(c1,
                                                                     c2,
        ...
        {
            length[hc_cc_rs::TcTST] = hcpm0_reeds_shepp_->TcTST_path(c1,
                                                                     c2,
        ...
        {
            length[hc_cc_rs::TcTSTcT] = hcpm0_reeds_shepp_->TcTSTcT_path(c1,
                                                                         c2,
        ...
        {
            length[hc_cc_rs::TTcTT] = hcpm0_reeds_shepp_->TTcTT_path(c1,
                                                                     c2,
        ...
        {
            length[hc_cc_rs::TcTTcT] = hcpm0_reeds_shepp_->TcTTcT_path(c1,
                                                                       c2,
        ...
        {
            length[hc_cc_rs::TTT] = hcpm0_reeds_shepp_->TTT_path(c1,
                                                                 c2,
                                                                 &cstart[hc_cc_rs::TTT],
                                                                 &cend[hc_cc_rs::TTT],
                                                                 &qi1[hc_cc_rs::TTT],
        ...
        {
            length[hc_cc_rs::TcST] = hcpm0_reeds_shepp_->TcST_path(c1,
                                                                   c2,
        ...
        {
            length[hc_cc_rs::TScT] = hcpm0_reeds_shepp_->TScT_path(c1,
                                                                   c2,
        ...
        {
            length[hc_cc_rs::TcScT] = hcpm0_reeds_shepp_->TcScT_path(c1,
                                                                     c2,
    ...
    HC_CC_RS_Path* HCpm0_Reeds_Shepp_State_Space::hcpm0_reeds_shepp(const State& state1,
    ...
    double HCpm0_Reeds_Shepp_State_Space::get_distance(const State& state1,
                                                       const State& state2) const
    {
    ...
    vector<Control> HCpm0_Reeds_Shepp_State_Space::get_controls(const State& state1,
                                                                const State& state2) const
    {
