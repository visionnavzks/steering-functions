...
namespace steering
{
    ...
    public:
                       ...
                       Configuration**     q2) const
        {
            ...
            *cstart =
                new HC_CC_Circle(c1.start, c1.left, c1.forward, true, parent_->hc_cc_circle_param_);
            *cend =
                new HC_CC_Circle(**q1, c2.left, !c2.forward, true, parent_->hc_cc_circle_param_);
    ...
    CC0pm_Dubins_State_Space::CC0pm_Dubins_State_Space(double kappa,
                                                       double sigma,
    ...
    CC_Dubins_Path*
    CC0pm_Dubins_State_Space::cc0pm_circles_dubins_path(const HC_CC_Circle& c1,
                                                        const HC_CC_Circle& c2) const
    {
        ...
        {
            cstart[cc_dubins::T] =
                new HC_CC_Circle(c1.start, c1.left, c1.forward, true, hc_cc_circle_param_);
        ...
        {
            length[cc_dubins::TT] = cc0pm_dubins_->TT_path(c1,
                                                           c2,
                                                           &cstart[cc_dubins::TT],
                                                           &cend[cc_dubins::TT],
                                                           &qi1[cc_dubins::TT],
        ...
        {
            length[cc_dubins::TST] = cc0pm_dubins_->TST_path(c1,
                                                             c2,
        ...
        {
            length[cc_dubins::TTT] = cc0pm_dubins_->TTT_path(c1,
                                                             c2,
    ...
    CC_Dubins_Path* CC0pm_Dubins_State_Space::cc0pm_dubins(const State& state1,
    ...
    vector<Control> CC0pm_Dubins_State_Space::get_controls(const State& state1,
                                                           const State& state2) const
    {
