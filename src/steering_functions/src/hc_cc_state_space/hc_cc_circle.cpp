...
namespace steering
{
    ...
    void HC_CC_Circle_Param::set_param(double _kappa,
                                       double _sigma,
                                       double _radius,
                                       double _mu,
                                       double _sin_mu,
    ...
    HC_CC_Circle::HC_CC_Circle(const Configuration&      _start,
                               bool                      _left,
                               bool                      _forward,
                               bool                      _regular,
    ...
    HC_CC_Circle::HC_CC_Circle(double                    _xc,
                               double                    _yc,
                               bool                      _left,
                               bool                      _forward,
                               bool                      _regular,
    ...
    bool HC_CC_Circle::cc_elementary_sharpness(const Configuration& q,
                                               double               delta,
                                               double&              sigma0) const
    {
        double distance = point_distance(this->start.x, this->start.y, q.x, q.y);
        //   existence conditions for an elementary path (also see: A. Scheuer and T. Fraichard,
        //   "Continuous-Curvature Path Planning for Car-Like Vehicles," in IEEE/RSJ International
    ...
    double HC_CC_Circle::cc_turn_length(const Configuration& q) const
    {
        ...
        double length_default =
            2 * length_min + fabs(this->kappa_inv * this->cc_circular_deflection(delta));
