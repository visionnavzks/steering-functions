...
namespace steering
{
    ...
    public:
        explicit CC00_Reeds_Shepp(CC00_Reeds_Shepp_State_Space* parent) { parent_ = parent; }
        ...
        {
            return path_helpers::TcT_exists(distance, c1, c2, 2 * c1.radius * c1.cos_mu);
        }
        ...
        {
            return path_helpers::TcTcT_exists(distance, c1, c2, 4 * c1.radius * c1.cos_mu);
        }
                          ...
                          HC_CC_Circle**      ci) const
        {
            ...
            middle1 = new HC_CC_Circle(
                *qa, !c1.left, !c1.forward, c1.regular, parent_->hc_cc_circle_param_);
            middle2 = new HC_CC_Circle(
                *qc, !c1.left, !c1.forward, c1.regular, parent_->hc_cc_circle_param_);

            // select shortest connection
            double length1 =
                c1.cc_turn_length(*qa) + middle1->cc_turn_length(*qb) + c2.cc_turn_length(*qb);
            double length2 =
                c1.cc_turn_length(*qc) + middle2->cc_turn_length(*qd) + c2.cc_turn_length(*qd);
            if (length1 < length2)
            {
                *q1 = qa;
                *q2 = qb;
        ...
        {
            return path_helpers::TcTT_exists(distance, c1, c2, 2 * c1.radius * (1 + c1.cos_mu), 2 * c1.radius * (1 - c1.cos_mu));
        }
        ...
        {
            return path_helpers::TTcT_exists(distance, c1, c2, 2 * c1.radius * (1 + c1.cos_mu), 2 * c1.radius * (1 - c1.cos_mu));
        }
        ...
        bool TiSTcT_exists(const HC_CC_Circle& c1, const HC_CC_Circle& c2) const
        {
            ...
            return (distance >=
                    2 * c1.radius * sqrt(1 + 2 * c1.sin_mu * c1.cos_mu + pow(c1.cos_mu, 2)));
        }
                           ...
                           HC_CC_Circle**      ci) const
        {
            ...
            *ci = new HC_CC_Circle(
                **q2, !c1.left, c1.forward, c1.regular, parent_->hc_cc_circle_param_);
                           ...
                           HC_CC_Circle**      ci) const
        {
            ...
            *ci = new HC_CC_Circle(
                **q1, !c1.left, !c1.forward, c1.regular, parent_->hc_cc_circle_param_);
        ...
        bool TcTiSTcT_exists(const HC_CC_Circle& c1, const HC_CC_Circle& c2) const
        {
            ...
            return (distance >=
                    2 * c1.radius * sqrt(1 + 4 * c1.cos_mu * c1.sin_mu + 4 * pow(c1.cos_mu, 2)));
        }
                             ...
                             HC_CC_Circle**      ci2) const
        {
            ...
            *ci1 = new HC_CC_Circle(
                **q1, !c1.left, !c1.forward, c1.regular, parent_->hc_cc_circle_param_);
            *ci2 = new HC_CC_Circle(
                **q3, !c2.left, c2.forward, c2.regular, parent_->hc_cc_circle_param_);
        ...
        {
            return path_helpers::TTcTT_exists(distance, c1, c2, 2 * c1.radius * (c1.cos_mu + 2));
        }
                          ...
                          HC_CC_Circle**      ci2) const
        {
            ...
            middle1 = new HC_CC_Circle(
                *qa, !c1.left, c1.forward, c1.regular, parent_->hc_cc_circle_param_);
            middle2 = new HC_CC_Circle(
                *qb, !c2.left, !c2.forward, c2.regular, parent_->hc_cc_circle_param_);
            middle3 = new HC_CC_Circle(
                *qd, !c1.left, c1.forward, c1.regular, parent_->hc_cc_circle_param_);
            middle4 = new HC_CC_Circle(
                *qe, !c2.left, !c2.forward, c2.regular, parent_->hc_cc_circle_param_);
        ...
        {
            return path_helpers::TcTTcT_exists(distance, c1, c2, 2 * c1.radius * (2 * c1.cos_mu + 1), 2 * c1.radius * (2 * c1.cos_mu - 1));
        }
                           ...
                           HC_CC_Circle**      ci2) const
        {
            ...
            middle1 = new HC_CC_Circle(
                *qa, !c1.left, !c1.forward, c1.regular, parent_->hc_cc_circle_param_);
            middle2 = new HC_CC_Circle(
                *qb, c1.left, !c1.forward, c1.regular, parent_->hc_cc_circle_param_);
            middle3 = new HC_CC_Circle(
                *qd, !c1.left, !c1.forward, c1.regular, parent_->hc_cc_circle_param_);
            middle4 = new HC_CC_Circle(
                *qe, c1.left, !c1.forward, c1.regular, parent_->hc_cc_circle_param_);
    ...
    CC00_Reeds_Shepp_State_Space::CC00_Reeds_Shepp_State_Space(double kappa,
                                                               double sigma,
    ...
    HC_CC_RS_Path* CC00_Reeds_Shepp_State_Space::cc00_circles_rs_path(const HC_CC_Circle& c1,
                                                                      const HC_CC_Circle& c2) const
    {
        ...
        if (cc00_reeds_shepp_->TcTcT_exists(c1, c2))
        {
            ...
            length[hc_cc_rs::TcTcT] = cc00_reeds_shepp_->TcTcT_path(*cstart[hc_cc_rs::TcTcT],
                                                                    *cend[hc_cc_rs::TcTcT],
                                                                    &qi1[hc_cc_rs::TcTcT],
                                                                    &qi2[hc_cc_rs::TcTcT],
                                                                    &ci1[hc_cc_rs::TcTcT]);
        ...
        if (cc00_reeds_shepp_->TcTT_exists(c1, c2))
        {
            ...
            length[hc_cc_rs::TcTT] = cc00_reeds_shepp_->TcTT_path(*cstart[hc_cc_rs::TcTT],
                                                                  *cend[hc_cc_rs::TcTT],
                                                                  &qi1[hc_cc_rs::TcTT],
                                                                  &qi2[hc_cc_rs::TcTT],
                                                                  &ci1[hc_cc_rs::TcTT]);
        ...
        if (cc00_reeds_shepp_->TTcT_exists(c1, c2))
        {
            ...
            length[hc_cc_rs::TTcT] = cc00_reeds_shepp_->TTcT_path(*cstart[hc_cc_rs::TTcT],
                                                                  *cend[hc_cc_rs::TTcT],
                                                                  &qi1[hc_cc_rs::TTcT],
                                                                  &qi2[hc_cc_rs::TTcT],
                                                                  &ci1[hc_cc_rs::TTcT]);
        ...
        if (cc00_reeds_shepp_->TST_exists(c1, c2))
        {
            ...
            length[hc_cc_rs::TST] = cc00_reeds_shepp_->TST_path(*cstart[hc_cc_rs::TST],
                                                                *cend[hc_cc_rs::TST],
                                                                &qi1[hc_cc_rs::TST],
                                                                &qi2[hc_cc_rs::TST]);
        }
        ...
        if (cc00_reeds_shepp_->TSTcT_exists(c1, c2))
        {
            ...
            length[hc_cc_rs::TSTcT] = cc00_reeds_shepp_->TSTcT_path(*cstart[hc_cc_rs::TSTcT],
                                                                    *cend[hc_cc_rs::TSTcT],
                                                                    &qi1[hc_cc_rs::TSTcT],
                                                                    &qi2[hc_cc_rs::TSTcT],
                                                                    &qi3[hc_cc_rs::TSTcT],
        ...
        if (cc00_reeds_shepp_->TcTST_exists(c1, c2))
        {
            ...
            length[hc_cc_rs::TcTST] = cc00_reeds_shepp_->TcTST_path(*cstart[hc_cc_rs::TcTST],
                                                                    *cend[hc_cc_rs::TcTST],
                                                                    &qi1[hc_cc_rs::TcTST],
                                                                    &qi2[hc_cc_rs::TcTST],
                                                                    &qi3[hc_cc_rs::TcTST],
        ...
        if (cc00_reeds_shepp_->TcTSTcT_exists(c1, c2))
        {
            ...
            length[hc_cc_rs::TcTSTcT] = cc00_reeds_shepp_->TcTSTcT_path(*cstart[hc_cc_rs::TcTSTcT],
        ...
        if (cc00_reeds_shepp_->TTcTT_exists(c1, c2))
        {
            ...
            length[hc_cc_rs::TTcTT] = cc00_reeds_shepp_->TTcTT_path(*cstart[hc_cc_rs::TTcTT],
                                                                    *cend[hc_cc_rs::TTcTT],
                                                                    &qi1[hc_cc_rs::TTcTT],
                                                                    &qi2[hc_cc_rs::TTcTT],
                                                                    &qi3[hc_cc_rs::TTcTT],
        ...
        if (cc00_reeds_shepp_->TcTTcT_exists(c1, c2))
        {
            ...
            length[hc_cc_rs::TcTTcT] = cc00_reeds_shepp_->TcTTcT_path(*cstart[hc_cc_rs::TcTTcT],
        ...
        if (cc00_reeds_shepp_->TTT_exists(c1, c2))
        {
            ...
            length[hc_cc_rs::TTT] = cc00_reeds_shepp_->TTT_path(*cstart[hc_cc_rs::TTT],
                                                                *cend[hc_cc_rs::TTT],
                                                                &qi1[hc_cc_rs::TTT],
                                                                &qi2[hc_cc_rs::TTT],
                                                                &ci1[hc_cc_rs::TTT]);
        ...
        if (cc00_reeds_shepp_->TcST_exists(c1, c2))
        {
            ...
            length[hc_cc_rs::TcST] = cc00_reeds_shepp_->TcST_path(*cstart[hc_cc_rs::TcST],
                                                                  *cend[hc_cc_rs::TcST],
                                                                  &qi1[hc_cc_rs::TcST],
                                                                  &qi2[hc_cc_rs::TcST]);
        }
        ...
        if (cc00_reeds_shepp_->TScT_exists(c1, c2))
        {
            ...
            length[hc_cc_rs::TScT] = cc00_reeds_shepp_->TScT_path(*cstart[hc_cc_rs::TScT],
                                                                  *cend[hc_cc_rs::TScT],
                                                                  &qi1[hc_cc_rs::TScT],
                                                                  &qi2[hc_cc_rs::TScT]);
        }
        ...
        if (cc00_reeds_shepp_->TcScT_exists(c1, c2))
        {
            ...
            length[hc_cc_rs::TcScT] = cc00_reeds_shepp_->TcScT_path(*cstart[hc_cc_rs::TcScT],
                                                                    *cend[hc_cc_rs::TcScT],
                                                                    &qi1[hc_cc_rs::TcScT],
                                                                    &qi2[hc_cc_rs::TcScT]);
        }
    ...
    HC_CC_RS_Path* CC00_Reeds_Shepp_State_Space::cc00_reeds_shepp(const State& state1,
                                                                  const State& state2) const
    {
        ...
        double lengths[] = {numeric_limits<double>::max(),
        ...
        for (int i = 0; i < 4; i++)
        {
            for (int j = 0; j < 4; j++)
            {
                paths[4 * i + j] = cc00_circles_rs_path(*start_circle[i], *end_circle[j]);
                if (paths[4 * i + j])
                {
                    lengths[4 * i + j] = paths[4 * i + j]->length;
                }
            }
        }

        // select shortest path
        int best_path = array_index_min(lengths, 16);
    ...
    double CC00_Reeds_Shepp_State_Space::get_distance(const State& state1,
                                                      const State& state2) const
    {
    ...
    vector<Control> CC00_Reeds_Shepp_State_Space::get_controls(const State& state1,
                                                               const State& state2) const
    {
