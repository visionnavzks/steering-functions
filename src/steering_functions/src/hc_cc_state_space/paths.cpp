...
namespace steering
{
    ...
    Path::Path(const Configuration& _start,
    ...
    void
    straight_controls(const Configuration& q1, const Configuration& q2, vector<Control>& controls)
    {
    ...
    void rs_turn_controls(const HC_CC_Circle&  c,
    ...
    void cc_default_controls(const HC_CC_Circle&  c,
                             const Configuration& q,
                             double               delta,
                             bool                 order,
                             vector<Control>&     controls)
                          ...
                          vector<Control>&     controls)
    {
        ...
        else if (delta < 2 * c.delta_min)
        {
            ...
            if (cc_elementary_controls(c, q, delta, order, controls_elementary))
            {
                ...
                double length_elementary = accumulate(controls_elementary.begin(),
                                                      controls_elementary.end(),
                                                      0.0,
                                                      [](double sum, const Control& control)
                                                      { return sum + fabs(control.delta_s); });
                double length_default    = accumulate(controls_default.begin(),
                ...
                (length_elementary < length_default)
                       ? controls.insert(
                          controls.end(), controls_elementary.begin(), controls_elementary.end())
                       : controls.insert(
                          controls.end(), controls_default.begin(), controls_default.end());
                return;
            }
            else
            {
