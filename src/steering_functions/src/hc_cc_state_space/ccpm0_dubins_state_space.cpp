...
namespace steering
{
    ...
    public:
        explicit CCpm0_Dubins(CCpm0_Dubins_State_Space* parent) { parent_ = parent; }
                       ...
                       Configuration**     q2) const
        {
            ...
            *cend =
                new HC_CC_Circle(c2.start, c2.left, c2.forward, true, parent_->hc_cc_circle_param_);
    ...
    CCpm0_Dubins_State_Space::CCpm0_Dubins_State_Space(double kappa,
                                                       double sigma,
    ...
    CC_Dubins_Path*
    CCpm0_Dubins_State_Space::ccpm0_circles_dubins_path(const HC_CC_Circle& c1,
                                                        const HC_CC_Circle& c2) const
    {
        ...
        {
            cend[cc_dubins::T] =
                new HC_CC_Circle(c2.start, c2.left, c2.forward, true, hc_cc_circle_param_);
        ...
        {
            length[cc_dubins::TT] = ccpm0_dubins_->TT_path(c1,
                                                           c2,
                                                           &cstart[cc_dubins::TT],
                                                           &cend[cc_dubins::TT],
                                                           &qi1[cc_dubins::TT],
        ...
        {
            length[cc_dubins::TST] = ccpm0_dubins_->TST_path(c1,
                                                             c2,
        ...
        {
            length[cc_dubins::TTT] = ccpm0_dubins_->TTT_path(c1,
                                                             c2,
    ...
    CC_Dubins_Path* CCpm0_Dubins_State_Space::ccpm0_dubins(const State& state1,
    ...
    vector<Control> CCpm0_Dubins_State_Space::get_controls(const State& state1,
                                                           const State& state2) const
    {
