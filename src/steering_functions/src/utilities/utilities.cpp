...
namespace steering
{
    ...
    void fresnel_8_inf(double x, double& S_f, double& C_f)
    {
        ...
        double sin_x = sin(x), cos_x = cos(x), sqrt_x = sqrt(x);
                         ...
                         double* kappa_f)
    {
        ...
        double cos_k1 = cos(k1), sin_k1 = sin(k1);
        double fresnel_s_k2, fresnel_c_k2, fresnel_s_k3, fresnel_c_k3;
        ...
        *theta_f = pify(theta_i + kappa_i * direction * length +
