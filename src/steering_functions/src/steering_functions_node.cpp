    ...
    void visualize(const vector<State_With_Covariance>& path)
    {
        ...
        for (const auto& state : path)
        {
            ...
            costmap_2d::transformFootprint(
                wheel_fl_pos_.x, wheel_fl_pos_.y, steer_angle_fl, wheel_, wheel_fl);
            costmap_2d::transformFootprint(
...
int main(int argc, char** argv)
{
    ...
    while (ros::ok())
    {
        ...
        PathClass cc00_dubins_path(
            "CC00_Dubins", start_wout_curv, goal_wout_curv, robot.kappa_max_, robot.sigma_max_);
        PathClass cc0pm_dubins_path(
            "CC0pm_Dubins", start_wout_curv, goal_wout_curv, robot.kappa_max_, robot.sigma_max_);
        PathClass ccpm0_dubins_path(
            "CCpm0_Dubins", start_wout_curv, goal_wout_curv, robot.kappa_max_, robot.sigma_max_);
        PathClass ccpmpm_dubins_path(
            "CCpmpm_Dubins", start_wout_curv, goal_wout_curv, robot.kappa_max_, robot.sigma_max_);
        PathClass dubins_path(
            "Dubins", start_wout_curv, goal_wout_curv, robot.kappa_max_, robot.sigma_max_);
        PathClass cc00_rs_path(
            "CC00_RS", start_wout_curv, goal_wout_curv, robot.kappa_max_, robot.sigma_max_);
        PathClass hc_rs_path("HC_RS", start, goal, robot.kappa_max_, robot.sigma_max_);
        PathClass hc00_rs_path(
            "HC00_RS", start_wout_curv, goal_wout_curv, robot.kappa_max_, robot.sigma_max_);
        PathClass hc0pm_rs_path(
            "HC0pm_RS", start_wout_curv, goal_wout_curv, robot.kappa_max_, robot.sigma_max_);
        PathClass hcpm0_rs_path(
            "HCpm0_RS", start_wout_curv, goal_wout_curv, robot.kappa_max_, robot.sigma_max_);
        PathClass hcpmpm_rs_path(
            "HCpmpm_RS", start_wout_curv, goal_wout_curv, robot.kappa_max_, robot.sigma_max_);
        PathClass rs_path(
            "RS", start_wout_curv, goal_wout_curv, robot.kappa_max_, robot.sigma_max_);
