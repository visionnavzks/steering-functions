...
# ---------------------------------------------------------------------------
# Layout-driven RS family evaluation (shared across all 4 HC variants)
# ---------------------------------------------------------------------------
_RS_FIELDS = ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'qi4', 'ci1', 'ci2')

_RS_NULLABLE = frozenset((
    'TST', 'TSTcT', 'TcTST', 'TcTSTcT', 'TcST', 'TScT', 'TcScT',
))

_RS_FAMILY_NAMES = (
    'TT', 'TcT', 'TcTcT', 'TcTT', 'TTcT',
    'TST', 'TSTcT', 'TcTST', 'TcTSTcT',
    'TTcTT', 'TcTTcT', 'TTT',
    'TcST', 'TScT', 'TcScT',
)
...
_HC00_LAYOUTS = {
    'TT':      ('cstart', 'cend', 'qi1'),
    'TcT':     ('cstart', 'cend', 'qi1'),
    'TcTcT':   ('cstart', 'cend', 'qi1', 'qi2', 'ci1'),
    'TcTT':    ('cstart', 'cend', 'qi1', 'qi2', 'ci1'),
    'TTcT':    ('cstart', 'cend', 'qi1', 'qi2', 'ci1'),
    'TST':     ('cstart', 'cend', 'qi1', 'qi2'),
    'TSTcT':   ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'ci1'),
    'TcTST':   ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'ci1'),
    'TcTSTcT': ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'qi4', 'ci1', 'ci2'),
    'TTcTT':   ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'ci1', 'ci2'),
    'TcTTcT':  ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'ci1', 'ci2'),
    'TTT':     ('cstart', 'cend', 'qi1', 'qi2', 'ci1'),
    'TcST':    ('cstart', 'cend', 'qi1', 'qi2'),
    'TScT':    ('cstart', 'cend', 'qi1', 'qi2'),
    'TcScT':   ('cstart', 'cend', 'qi1', 'qi2'),
}

_HC0PM_LAYOUTS = {
    'TT':      ('cstart', 'cend', 'qi1', 'qi2'),
    'TcT':     ('cstart', 'cend', 'qi1'),
    'TcTcT':   ('cstart', 'cend', 'qi1', 'qi2', 'ci1'),
    'TcTT':    ('cstart', 'cend', 'qi1', 'qi2', 'ci1'),
    'TTcT':    ('cstart', 'cend', 'qi1', 'qi2', 'ci1'),
    'TST':     ('cstart', 'cend', 'qi1', 'qi2', 'qi3'),
    'TSTcT':   ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'ci1'),
    'TcTST':   ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'qi4', 'ci1'),
    'TcTSTcT': ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'qi4', 'ci1', 'ci2'),
    'TTcTT':   ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'ci1', 'ci2'),
    'TcTTcT':  ('cstart', 'cend', 'qi1', 'qi2', 'ci1', 'ci2'),
    'TTT':     ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'ci1'),
    'TcST':    ('cstart', 'cend', 'qi1', 'qi2', 'qi3'),
    'TScT':    ('cstart', 'cend', 'qi1', 'qi2'),
    'TcScT':   ('cstart', 'cend', 'qi1', 'qi2'),
}
...
_HCPM0_LAYOUTS = {
    ...
    'TTcT':    ('cstart', 'cend', 'qi1', 'qi2', 'ci1'),
    'TST':     ('cstart', 'cend', 'qi1', 'qi2', 'qi3'),
    'TSTcT':   ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'qi4', 'ci1'),
    'TcTST':   ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'ci1'),
    'TcTSTcT': ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'qi4', 'ci1', 'ci2'),
    'TTcTT':   ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'ci1', 'ci2'),
    'TcTTcT':  ('cstart', 'cend', 'qi1', 'qi2', 'ci1', 'ci2'),
    'TTT':     ('cstart', 'cend', 'qi1', 'qi2', 'ci1'),
    'TcST':    ('cstart', 'cend', 'qi1', 'qi2'),
    'TScT':    ('cstart', 'cend', 'qi1', 'qi2', 'qi3'),
    'TcScT':   ('cstart', 'cend', 'qi1', 'qi2'),
}

_HCPMPM_LAYOUTS = {
    'TT':      ('cstart', 'cend', 'qi1', 'qi2', 'qi3'),
    'TcT':     ('cstart', 'cend', 'qi1'),
    'TcTcT':   ('cstart', 'cend', 'qi1', 'qi2', 'ci1'),
    'TcTT':    ('cstart', 'cend', 'qi1', 'qi2', 'ci1'),
    'TTcT':    ('cstart', 'cend', 'qi1', 'qi2', 'ci1'),
    'TST':     ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'qi4'),
    'TSTcT':   ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'qi4', 'ci1'),
    'TcTST':   ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'qi4', 'ci1'),
    'TcTSTcT': ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'qi4', 'ci1', 'ci2'),
    'TTcTT':   ('cstart', 'cend', 'qi1', 'qi2', 'qi3', 'ci1', 'ci2'),
...
def _evaluate_rs_families(h, c1, c2, layouts):
    """Evaluate all 15 RS path families, returning parallel result arrays.

    Parameters
    ----------
    h : helper object with ``<name>_exists`` / ``<name>_path`` methods
    c1, c2 : HC_CC_Circle start/end circles
    layouts : dict mapping family name -> tuple of field names describing
        the result-tuple layout *after* the leading ``length`` element.

    Returns
    -------
    length : list[float]   - per-path-type lengths (unused = _INF)
    arrays : dict[str, list] - field name -> per-path-type values (unused = None)
    """
    tp = hc_cc_rs_path_type
    num_types = len(tp)
    length = [_INF] * num_types
    arrays = {f: [None] * num_types for f in _RS_FIELDS}

    for name in _RS_FAMILY_NAMES:
        idx = getattr(tp, name)
        if not getattr(h, name + '_exists')(c1, c2):
            continue
        r = getattr(h, name + '_path')(c1, c2)
        if name in _RS_NULLABLE and r is None:
            continue
        length[idx] = r[0]
        layout = layouts[name]
        for i, field in enumerate(layout):
            arrays[field][idx] = r[i + 1]

    return length, arrays


def _select_rs_best(c1_start, c2_start, kappa, sigma, length, arrays):
    """Select the shortest path from the evaluation result arrays."""
    best = min(range(len(length)), key=lambda i: length[i])
    a = arrays
    return HC_CC_RS_Path(
        c1_start, c2_start, hc_cc_rs_path_type(best),
        kappa, sigma,
        a['qi1'][best], a['qi2'][best], a['qi3'][best], a['qi4'][best],
        a['cstart'][best], a['cend'][best], a['ci1'][best], a['ci2'][best],
        length[best],
    )
...
class HC00_Reeds_Shepp_State_Space(HC_CC_StateSpace):
    ...
    def hc00_circles_rs_path(self, c1, c2):
        ...
        # --- evaluate all 15 families ---
        length, arrays = _evaluate_rs_families(h, c1, c2, _HC00_LAYOUTS)
        return _select_rs_best(c1.start, c2.start, self.kappa_, self.sigma_, length, arrays)
...
class HC0pm_Reeds_Shepp_State_Space(HC_CC_StateSpace):
    ...
    def hc0pm_circles_rs_path(self, c1, c2):
        ...
        if configuration_equal(c1.start, c2.start):
            return HC_CC_RS_Path(c1.start, c2.start, tp.E, self.kappa_, self.sigma_,
                                 None, None, None, None, None, None, None, None, 0)
        if h.distance < get_epsilon():
            cs = HC_CC_Circle(c1.start, c1.left, c1.forward, _HC_REGULAR, p)
            return HC_CC_RS_Path(c1.start, c2.start, tp.T, self.kappa_, self.sigma_,
                                 None, None, None, None, cs, None, None, None,
                                 cs.hc_turn_length(c2.start))

        # --- evaluate all 15 families ---
        length, arrays = _evaluate_rs_families(h, c1, c2, _HC0PM_LAYOUTS)
        return _select_rs_best(c1.start, c2.start, self.kappa_, self.sigma_, length, arrays)
    ...
    def hcpm0_circles_rs_path(self, c1, c2):
        ...
        if configuration_equal(c1.start, c2.start):
            return HC_CC_RS_Path(c1.start, c2.start, tp.E, self.kappa_, self.sigma_,
                                 None, None, None, None, None, None, None, None, 0)
        if h.distance < get_epsilon():
            ce = HC_CC_Circle(c2.start, c2.left, c2.forward, _HC_REGULAR, p)
            return HC_CC_RS_Path(c1.start, c2.start, tp.T, self.kappa_, self.sigma_,
                                 None, None, None, None, None, ce, None, None,
                                 ce.hc_turn_length(c1.start))

        # --- evaluate all 15 families ---
        length, arrays = _evaluate_rs_families(h, c1, c2, _HCPM0_LAYOUTS)
        return _select_rs_best(c1.start, c2.start, self.kappa_, self.sigma_, length, arrays)
    ...
    def hcpmpm_circles_rs_path(self, c1, c2):
        ...
        if configuration_equal(c1.start, c2.start):
            return HC_CC_RS_Path(c1.start, c2.start, tp.E, self.kappa_, self.sigma_,
                                 None, None, None, None, None, None, None, None, 0)
        if configuration_on_hc_cc_circle(c1, c2.start):
            cs = HC_CC_Circle(c1.start, c1.left, c1.forward, True, self.rs_circle_param_)
            return HC_CC_RS_Path(c1.start, c2.start, tp.T, self.kappa_, self.sigma_,
                                 None, None, None, None, cs, None, None, None,
                                 cs.rs_turn_length(c2.start))

        # --- evaluate all 15 families ---
        length, arrays = _evaluate_rs_families(h, c1, c2, _HCPMPM_LAYOUTS)
        return _select_rs_best(c1.start, c2.start, self.kappa_, self.sigma_, length, arrays)
